...
If the above step is insufficient, navigate to the directory /sys/fs/cgroup/unified/docker/<long-image-id>/cgroup.procs to view PPIDs. A simple shell command can then be executed to map these PIDs.
